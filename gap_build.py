...
H=('<!doctype html><html lang="zh-Hant"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
 ...
 '<div class="conds">'
 '<span class="num"><label class="ck"><input type="checkbox" id="zb">站上布林 超</label><input id="zbv" value="0">%</span>'
 '<span class="num"><label class="ck"><input type="checkbox" id="lb">臨近布林 距</label><input id="lbv" value="2">%</span>'
