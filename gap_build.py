...
def _dualstr(px,R,ma5,ma10,ma20,bu):
    ...
    lv=[('壓R%d'%(i+1),P[i]) for i in range(3)]+[('撐S%d'%(j+1),S[j]) for j in range(3)]
    mp={}
    for nm,v in LN:
